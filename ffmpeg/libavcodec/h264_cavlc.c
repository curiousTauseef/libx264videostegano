...
//                fill_intra4x4_pred_table(h);
            ...
            // --------------- ebi start -------------------
                if(sl->intra16x16_pred_mode == 0 || sl->intra16x16_pred_mode == 2 || sl->intra16x16_pred_mode == 4) {
                    decode_msg_add_bit(0, h->decodedMessage);
                }
                else if(sl->intra16x16_pred_mode == 1 || sl->intra16x16_pred_mode == 3 || sl->intra16x16_pred_mode == 5) {
                    decode_msg_add_bit(1, h->decodedMessage);
                }
            // --------------- ebi end -------------------
