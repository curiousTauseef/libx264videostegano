...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=. --enable-shared --extra-cflags='-gstabs+ -I../libx264' --extra-ldflags=-L../libx264/lib --enable-ffplay --enable-libx264 --enable-gpl --enable-pic --disable-yasm --disable-pthreads
prefix=.
...
CC_IDENT=gcc 7 (Ubuntu 7.2.0-1ubuntu1~16.04)
ARCH=x86
INTRINSICS=none
CC=gcc
CXX=g++
...
CFLAGS=  -gstabs+ -I../libx264 -std=c99 -fomit-frame-pointer -fPIC -D_GNU_SOURCE=1 -D_REENTRANT -I/usr/include/SDL  -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++98
OBJCFLAGS=  
ASFLAGS=  -gstabs+ -I../libx264 -fPIC -g
AS_C=-c
AS_O=-o $@
OBJCC_C=-c
OBJCC_E=-E -o $@
...
DEPWINDRES=gcc
DOXYGEN=doxygen
LDFLAGS= -L../libx264/lib  -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDLIBFLAGS=
...
EXTRALIBS=-lvdpau -lva -lva-drm -lva -lva-x11 -lva -lxcb -lxcb-shm -lxcb -lxcb-xfixes -lxcb-render -lxcb-shape -lxcb -lxcb-shape -lxcb -lX11 -lasound -lSDL -lx264 -lm -llzma -lz 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
