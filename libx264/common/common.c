...
int x264_param_default_preset( x264_param_t *param, const char *preset, const char *tune )
{
    ...
    if( tune && x264_param_apply_tune( param, tune ) < 0 )
        return -1;
//    param->message = NULL;
    param->message = (stuMessage*)malloc(sizeof(stuMessage));
    param->message->width = param->i_width;
    param->message->height = param->i_height;
    param->message->isSendingMessage = 0;
    param->message->frameNumber = 0;
    param->message->numberOfEmbededBits = 0;
    param->message->gettingCapacity = 0;
    param->message->length=0;
    param->message->progress=0.0;
    param->message->isInitialized=0;
